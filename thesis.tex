...
\newtheorem{cor}[teo]{\scshaé Corol\'ario}
\newtheorem{propo}[teo]{\scshape Proposi\c{c}\~ao}
\newtheorem{defi}{\scshape Defini\c{c}\~ao}[chapter]
\newtheorem{ex}{\scshape Exemplo}[chapter]
...
\usepackage{algorithm} % pacote para o uso de algoritmos
\usepackage{algpseudocode} % pacote para o uso de algoritmos
% altera palavras chaves dos algoritmos para português
